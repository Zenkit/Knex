...
var batchInserter = require('../util/batch-insert')
...
assign(Builder.prototype, {
  ...
  // Sets the values for a "batch insert", limiting to 
  // the number of rows inserted at once.
  batchInsert: function(table, values, limit) {
    return batchInserter(this.client, table, values, parseInt(limit || 1, 10));
  },
